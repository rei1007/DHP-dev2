...
-- インデックスを作成
CREATE INDEX IF NOT EXISTS idx_casters_user_id ON casters(user_id);
CREATE INDEX IF NOT EXISTS idx_casters_name ON casters(name);
...
DO $$ 
BEGIN 
    RAISE NOTICE '✅ castersテーブルの作成が完了しました';
END $$;
